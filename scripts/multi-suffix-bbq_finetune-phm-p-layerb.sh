TOTAL_NUM_UPDATES=113702  # 10 epochs through RTE for bsz 16
WARMUP_UPDATES=6840      # 6 percent of the number of updates
...
CUDA_VISIBLE_DEVICES=$node fairseq-train BBQ-bin/ \
